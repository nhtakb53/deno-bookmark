...
export default function Bookmark({ card }: BookmarkProps) {
  return (
    <div
      key={card.id}
      class="relative w-52 h-60 bg-gray-800 text-white rounded-lg border border-gray-600 shadow-lg transition duration-300 transform hover:scale-105 hover:shadow-2xl flex flex-col"
    >
      {card.badge && (
        <div
